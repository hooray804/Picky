...
> [!IMPORTANT]
> **Picky(기본) 버전은 더 이상 업데이트되지 않습니다.** 최신 기능과 지속적인 관리를 위해 Picky Advanced 버전으로 전환해 주세요.
...
* **Shadow DOM 지원**: 일반적인 선택기로 접근이 어려운 Shadow Root 내부 요소 탐색 및 스타일 주입 기능을 포함합니다.
...
* URL 버튼 이용
![IMG_4](https://github.com/user-attachments/assets/ed88d4dc-bf03-413d-b0c9-87336c5c515e)
