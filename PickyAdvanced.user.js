...
(function() {
    ...
    const P = {
        ...
        viewSet() { 
            ...
            <div class="picky-button-grid" style="margin-top:8px;"><button data-action="resetBlocks" style="grid-column: 1 / -1; background-color: var(--pk-err); color: #fff;">이 사이트의 차단 규칙 초기화</button></div>
