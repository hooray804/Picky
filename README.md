...
* **Shadow DOM 지원**: 일반적인 도구로 접근하기 어려운 Shadow Root 내부 요소까지 검사 가능합니다.
* **코드 검사기**: 선택한 요소의 정렬된 HTML, 계산된 CSS, 연관된 JS 이벤트를 즉시 확인합니다.
* **다양한 편의 도구**: 요소 숨김/격리, URL 추출, 쿠키 관리 및 브라우저 핑거프린팅 정보 확인 기능을 포함합니다.
* **반응형 UI**: 데스크톱과 모바일 환경을 모두 지원하며, 미니멀 모드와 풀 모드로 전환이 자유롭습니다.

## 2. 버전 비교 (Picky vs Picky Advanced)

| 기능 | Picky (본 버전) | Picky Advanced |
| :--- | :--- | :--- |
